...
class TrafficController extends Controller
{
    ...
    public function redirect($campaignId, $serviceId, $operatorName,  $clickedID, Request $request)
    {
        ...
        $redirectUrl = $service->traffic_redirect_url;
        $redirectUrl = str_replace("{clickid}", $clickedID, $redirectUrl);
        $redirectUrl = str_replace("{opr}", $operatorName, $redirectUrl);
        $redirectUrl = str_replace("{channel}", $campaign->publisher->short_name, $redirectUrl);

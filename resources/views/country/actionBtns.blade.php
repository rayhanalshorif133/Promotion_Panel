<div class="mt-2 btn-group" data-id={{$id}} role="group" aria-label="Basic outlined example">
    <button class="px-3 btn btn-sm bg-gradient-info countryEditBtn" data-bs-toggle="modal" data-bs-target="#updateCountry"
        type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit item">
        <i class="fa fa-pen"></i>
    </button>
    <button class="px-3 btn btn-sm bg-gradient-danger countryDeleteBtn"

...
@section('content')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-full max-w-6xl px-3 mx-auto">
                <div
                    ...
                    <div
                        ...
                        <button
                            class="flex items-center justify-center w-auto h-auto px-3 py-1 mr-2 text-sm font-semibold text-center text-white transition-colors duration-500 ease-in-out delay-150 bg-center rounded fill-current shadow-soft-2xl bg-gradient-to-tl from-blue-600 to-cyan-400 hover:from-cyan-400 hover:to-blue-600">
                            Add Operator
                        </button>
                    </div>

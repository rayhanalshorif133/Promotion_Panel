...
<div class="w-full mx-auto card">
    <div class="flex justify-between px-4 pb-0 mt-4 mb-2">
        ...
        <div>
            <a href="{{ route('campaign.edit', $campaign->id) }}" class="px-3 btn btn-sm bg-gradient-info campaignEditBtn" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit item">
                <i class="fa fa-pen"></i>
            </a>
            <a href="{{ route('campaign.index') }}" class="px-3 btn btn-sm bg-gradient-danger" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Back to Campaign's List">
                <i class="fa-solid fa-arrow-left fa-beat"></i>
            </a>
        </div>
    </div>
</div>
<div class="w-full mx-auto card pb-4 pt-2 my-2">
...
<div class="card w-full pb-4 pt-2 my-2 mx-auto">
    <div class="p-3 pb-0 card-header">
    ...
    <div class="col-12 px-5 hidden lg:flex lg:col-12">
        <div class="pb-5 table-responsive pt-3 lg:w-full">
            <table class="table pb-3 mb-0 align-items-start" id="campaignDetailsTableId">
                <thead>
                    <tr>
                        <th class="align-self-start text-start text-uppercase text-secondary text-sm font-weight-bolder opacity-7">
                            #</th>
                        <th class="align-self-start text-start text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">
                            Operator Name</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            data-bs-placement="top" title="Copy to clipboard" id="campaignurl-{{ $campaignDetail->url }}">
                                <i class="p-2 text-gray-800 border-[1px] border-gray-800 rounded-full hover:text-gray-100 hover:bg-gray-800 fa-solid fa-copy"></i>
                            </div>
                        </td>
                    </tr>
                    @endforeach
        ...
        <div class="row">
            ...
            <div class="col-md-6 overflow-hidden">
                <div class="p-[1rem] sm:p-4 m-3 mx-2 sm:mx-0 shadow-sm shadow-slate-400 bg-gray-100">
                    <h2 class="text-base font-semibold text-gray-600"># <span class="text-base font-normal text-gray-500">{{ $loop->iteration }}</span></h2>
                    <h2 class="text-base font-semibold text-gray-600">Operator Name: <span class="text-base font-normal text-gray-500">{{ $campaignDetail->operator->name }}</span>
                    </h2>
                    <h2 class="text-base font-semibold text-gray-600">Service Name: <span class="text-base font-normal text-gray-500">{{ $campaignDetail->service->name }}</span>
                    </h2>
                    <h2 class="text-base font-semibold text-gray-600">Campaign Url: <br />
                        <span class="text-base font-normal text-gray-500 overflow-hidden">{{ $campaignDetail->url }}</span>
                    </h2>
                    <div class="rounded-full cursor-pointer w-10 campaignUrlCopyBtn" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy to clipboard" data-url="{{ $campaignDetail->url }}">
                        <i class="p-2 text-gray-800 border-[1px] border-gray-800 rounded-full hover:text-gray-100 hover:bg-gray-800 fa-solid fa-copy"></i>
                    </div>
...
<script>
    $(function() {
        ...
        $(".campaignUrlCopyBtn").click(function(){
            const url = $(this).attr('id').split('-')[1];
            copyToClipboard(url);
